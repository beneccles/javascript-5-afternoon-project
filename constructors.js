...
function Car(make, model, year) {
  // Assign what the values should be at start after its created.
  this.make = make;
  this.model = model;
  this.year = year;
  this.move = 0;
  // moveCar will increment move by 10 each time it is called.
...
// Write a prototype method for the User constructor function named removeSavedPost that will take in one
// number parameter representing the post id. Use this id to find and remove the matching object in the savedPosts array.
